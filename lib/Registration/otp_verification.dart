                  ...
                  new Container(
                      ...
                      child: new Container(
                        ...
                        child: new Column(children: <Widget>[
                          Padding(
                            padding: EdgeInsets.only(
                                left: Responsive.width(40.77, context),
                                right: Responsive.width(246.57, context),
                                top: Responsive.height(21.85, context),
                          ...
                          Padding(
                              padding: EdgeInsets.only(
                                  left: Responsive.width(60, context),
                                  right: Responsive.width(39, context),
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: Responsive.width(40, context),
                                right: Responsive.height(39, context),
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: Responsive.width(60, context),
                                right: Responsive.width(60, context)),
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: Responsive.width(62, context),
                                right: Responsive.width(61, context)),
                            child: Text(
                              'Didnt recieve OTP?',
                              style: TextStyle(
                                  fontFamily: 'Montserrat',
