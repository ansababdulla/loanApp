...
class _DashboardTabs extends State<DashboardTabs>
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              actions: <Widget>[
                ...
                IconButton(
                  icon: Image.asset(
                    ...
                    width: Responsive.width(36.74, context),
                    height: Responsive.height(36.74, context),
                  ),
                  onPressed: () => {},
                ),
                SizedBox(
                  width: Responsive.width(110.44, context),
              ...
              bottom: TabBar(
                ...
                labelPadding:
                    EdgeInsets.only(right: Responsive.width(60, context)),
                ...
                tabs: [
                  Tab(text: 'Dashboard'),
                  Tab(text: 'Rewards and Offers'),
                ],
              ),
            ),
            backgroundColor: Color(0xff191B23),
            body: TabBarView(children: [Dashboard(), RewardsAndOffers()]),
