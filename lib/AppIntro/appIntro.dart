        ...
        return Builder(
          builder: (BuildContext context) {
              return Column(
                ...
                Padding(padding:EdgeInsets.only(top :size.height * 0.04),
                  child:Text(i['text'],style:GoogleFonts.montserrat(textStyle:TextStyle(color: Colors.black,fontSize: size.height * 0.044 ,fontWeight: FontWeight.w700))),
                ),
                Padding(padding:EdgeInsets.only(top :size.height * 0.04),
                  child:Text(i['subText'],style: GoogleFonts.montserrat(textStyle:TextStyle(color: Colors.black,fontSize: size.height * 0.017,fontWeight: FontWeight.w500)),),
                ),
              ]
            );
          },
              ...
              child:Container(
                ...
                child:RaisedButton(
                  color: Color(0xff6478D3),
                    child:Text('Start',style:GoogleFonts.montserrat(fontSize: size.height * 0.025,color: Colors.white,fontWeight: FontWeight.w500)),
                    onPressed: () => {
