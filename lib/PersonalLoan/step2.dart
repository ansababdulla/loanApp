import 'package:chickly/PersonalLoan/step3.dart';
import 'package:chickly/PersonalLoan/uploadDocuments.dart';
...
class _StepTwoWorkState extends State<StepTwoPersonal> {
                              ...
                              if (formKey.currentState.validate())
                                {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => UploadDocPersonal()))
                                }
                            },
